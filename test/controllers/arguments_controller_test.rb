...
class ArgumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create argument" do
    assert_difference('Argument.count') do
      post arguments_url, params: { argument: { parameter_id: @argument.parameter_id, simulation_id: @argument.simulation_id, value: @argument.value } }
    end
  ...
  test "should update argument" do
    patch argument_url(@argument), params: { argument: { parameter_id: @argument.parameter_id, simulation_id: @argument.simulation_id, value: @argument.value } }
