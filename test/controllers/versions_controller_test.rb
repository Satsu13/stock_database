...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { model_id: @version.model_id, number: @version.number } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { model_id: @version.model_id, number: @version.number } }
